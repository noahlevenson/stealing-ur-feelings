const bootCVState = {
	create: function() {
		...
		if (!K_MULTITHREADING) {
			...
			const detectorModel = faceapi.nets.tinyFaceDetector.loadFromUri("lib/models");
			...
			detectorModel.then(() => {
    			...
    			loadGfx.drawRect(game.world.centerX - 300, game.world.centerY - 100, 200, 20);

				const landmarkModel = faceapi.nets.faceLandmark68TinyNet.loadFromUri("lib/models");
				...
				landmarkModel.then(() => {
					...
					loadGfx.drawRect(game.world.centerX - 300, game.world.centerY - 100, 600, 20);
					loadGfx.beginFill(0xFFFFFF, 1);
	    			loadGfx.drawRect(game.world.centerX - 300, game.world.centerY - 100, 400, 20);

					const expressionModel = faceapi.nets.faceExpressionNet.loadFromUri("lib/models");
					...
					expressionModel.then(() => {
						...
						clmCanvas = game.add.bitmapData(Math.round(640 / K_FACE_CV_DOWNRES_FACTOR), Math.round(480 / K_FACE_CV_DOWNRES_FACTOR));
						clmCanvas.copy("don", 0, 0, 640, 480, 0, 0, undefined, undefined, undefined, undefined, undefined, 1 / K_FACE_CV_DOWNRES_FACTOR, 1 / K_FACE_CV_DOWNRES_FACTOR);
						clmCanvas.update();
						...
						loadGfx.drawRect(game.world.centerX - 300, game.world.centerY - 100, 600, 20);
						loadGfx.beginFill(0xFFFFFF, 1);
						loadGfx.drawRect(game.world.centerX - 300, game.world.centerY - 100, 500, 20);
