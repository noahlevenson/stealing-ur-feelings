const bootState = {
  create: function () {
    const privacyText = game.add.text(
      0,
      0,
      "STEALING UR FEELINGS accesses your device camera and uses A.I. algorithms to analyze your video stream. We do NOT transmit, store, or share your data. STEALING UR FEELINGS is for entertainment purposes only. We are committed to respecting your privacy.",
      {
    ...
    const privacyTextHeader = game.add.text(
      0,
      0,
    ...
    privacyTextHeader.position = {
      x: privacyText.position.x - privacyText.width / 2,
      y: K_PROJECT_HEIGHT / 2 - 100,
    };
