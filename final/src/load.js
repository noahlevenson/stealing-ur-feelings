const loadState = {
	preload: function() {
		...
		game.load.image("kelloggsCornFlakes", "img/kelloggsCornFlakes.png", 497, 359);
		...
		game.load.image("thoughtBubbleHappy", "img/thoughtBubbleHappy.png", 500, 492);
		game.load.image("thoughtBubbleSad", "img/thoughtBubbleSad.png", 500, 493);
		game.load.image("mozillaLogoWhite", "img/moz-logo-1color-white-rgb.png", 375, 107);

		game.load.image("faceCameraAndCheckLighting", "img/faceCameraAndCheckLighting.png", 571, 80);
		game.load.image("pressRedButtonToStart", "img/pressRedButtonToStart.png", 451, 80);
		...
		for (let i = 0; i < 80; i += 1) {
			...
			game.load.image(`logoFrame${i}`, `img/logo_animation/Final_SteelingUrFeelings_Logo_03_${pidx}.png`);
		}
		...
		game.load.audio("youPreferWhitePeople", "sfx/ohio_tags/youPreferWhitePeople.mp3");
		game.load.audio("youPreferBlackPeople", "sfx/ohio_tags/youPreferBlackPeople.mp3");
