...
// Globals
let loadGfx, fullScreenButton, mozillaLogo, socket, faceModel, userEmotionalStateText, attractText, attractTween, faceModelGroup, backgroundBMD, backgroundSprite;
...
let dogsEvent, genderEvent, kanyeStartEvent, kanyeEndEvent, kanyeEvent, pizzaStartEvent, pizzaEndEvent, pizzaEvent, raceEvent, datingPreferenceEvent, socialNewsEvent, politicalOrientationEvent, iqEvent, estimatedIncomeEvent, mentalHealthEvent, selfImageEvent;

let eventText, eventScoreText, positivePercentText, negativePercentText, estimatedIncomeText, mentalHealthText, selfImageText, finalQuantTimer, iqText;
